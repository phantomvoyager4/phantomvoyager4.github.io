...
function Aboutme({ palette }) {
  return (
    <div className="flex flex-col items-center gap-[24px]">
      ...
      <div className="font-InriaSerif text-xl text-center max-w-4xl break-words" style={{ color: palette.aboutmeText }}>Happy to see you on my website! I am young polish student interested in programming and music. I've producing music since 2020,
      ...
      <div className="font-InriaSerif text-xl text-center max-w-4xl break-words" style={{ color: palette.aboutmeText }}> 
      ...
      <div className="font-InriaSerif text-4xl" style={{ color: palette.aboutmeText }}>
        My streaming services:
      </div>
      <div className="flex flex-row gap-[5px]">
        <a href="https://music.apple.com/us/artist/kashiami/1777722735" target="_blank" rel="noopener noreferrer">
                <img src={MusicD} alt="Logo" className="w-[100px] transition-transform duration-200 transform hover:scale-110" style={{ filter: `invert(${palette.icon === "#181818" ? 1 : 0})` }} />
        </a>
        <a href="https://www.youtube.com/@kashiami4" target="_blank" rel="noopener noreferrer">
                <img src={YoutubeD} alt="Logo" className="w-[100px] transition-transform duration-200 transform hover:scale-110" style={{ filter: `invert(${palette.icon === "#181818" ? 1 : 0})` }} />
        </a>
        <a href="https://open.spotify.com/artist/7yFxrWhhvzk9OQz2aTIhul?si=D1gHsCjJT2SYFYuA_Q9KsA" target="_blank" rel="noopener noreferrer">
                <img src={SpotifyD} alt="Logo" className="w-[100px] transition-transform duration-200 transform hover:scale-110" style={{ filter: `invert(${palette.icon === "#181818" ? 1 : 0})` }} />
        </a>
      </div>
      </div>
    </div>
